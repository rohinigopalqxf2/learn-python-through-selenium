...
def test_temp_form(base_url,browser,browser_version,os_version,os_name,remote_flag,remote_project_name,remote_build_name):
    ...
    try:
        ...
        # Check the heading of the redirected page
        ...
        # Click on the payment with card
        ...
        #6. Set Email in payment gateway
        ...
        #6. Set Card Number in payment gateway
        ...
        #6. Set Card expiry date in payment gateway
