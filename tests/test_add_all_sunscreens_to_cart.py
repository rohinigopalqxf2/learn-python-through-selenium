...
def test_add_all_sunscreens_to_cart(base_url,browser,browser_version,os_version,os_name,remote_flag,testrail_flag,tesults_flag,test_run_id,remote_project_name,remote_build_name):
    ...
    try:
        ...
        result_flag = test_obj.add_all_sunscreens_verify_cart() 
        test_obj.log_result(result_flag,
                            positive="All sunscreens added successfully to the cart\n",
                            negative="Failed to All sunscreens to the cart\nOn")
...
if __name__=='__main__':
    ...
    if options_obj.check_options(options): 
        #Run the test only if the options provided are valid
        test_add_all_sunscreens_to_cart(browser=options.browser,
