...
from .moisturizers_object import Moisturizers_Object
...
class Moisturizer_Page(Base_Page,Sunscreens_Moisturizers_Object,Moisturizers_Object,Checkout_Payment_Object):
